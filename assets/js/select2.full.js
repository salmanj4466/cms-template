                ...
                (o = function (e, t, i, o) {
                  ...
                  if (((o = o || e), "undefined" === $ || "function" === $)) {
                    for (
                      ...
                      if ("require" === (u = (h = s(t[f], o)).f))
                        w[f] = a.require(e);
                      else if ("exports" === u) (w[f] = a.exports(e)), (m = !0);
                      else if ("module" === u) r = w[f] = a.module(e);
                      else if (g(l, u) || g(c, u) || g(d, u)) w[f] = _(u);
                      else {
                        if (!h.p) throw Error(e + " missing " + u);
                        h.p.load(h.n, v(o, !0), y(u), {}), (w[f] = l[u]);
                      }
                    (p = i ? i.apply(l[e], w) : void 0),
                      e &&
                        (r && r.exports !== n && r.exports !== l[e]
                          ? (l[e] = r.exports)
                          : (p === n && m) || (l[e] = p));
                  } else e && (l[e] = i);
                }),
            ...
            return (
              (i.prototype.render = function (i) {
                ...
                return (
                  ...
                  t.syncCssClasses(o, this.$element, s),
                  o.css(l),
                  o.addClass(r),
                  o
                );
